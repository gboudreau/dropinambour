...
<div class="row row-cols-auto g-4 justify-content-center">
    <?php foreach ($medias ?? [] as $media) : ?>
        <div class="col">
            <a class="card movie_box <?php phe(AvailableMedia::getClassForMedia($media)) ?>" href="<?php phe(Router::getURL(Router::ACTION_VIEW, Router::VIEW_MEDIA, [$media->media_type => $media->id])) ?>">
